  ...
  async execute(interaction) {
    ...
    if (
      ...
      return interaction.reply({
        content: t(guildId, "mod.kick.NO_PERM"),
        flags,
      });
    }
    ...
    if (!target.kickable) {
      return interaction.reply({
        content: t(guildId, "mod.kick.CANNOT_KICK"),
        flags,
      });
    }
    ...
    if (logChannel) {
      const embed = new EmbedBuilder()
        ...
        .addFields(
          {
            name: t(guildId, "mod.kick.FIELD_USER"),
            value: target.user.tag,
            inline: true,
          },
          {
            name: t(guildId, "mod.kick.FIELD_MODERATOR"),
            value: interaction.user.tag,
            inline: true,
          },
          {
            name: t(guildId, "mod.kick.FIELD_REASON"),
            value: reason,
            inline: false,
          }
        )
